        ...
        >
          ...
          <div className="mt-5 grid grid-cols-3 gap-3 text-center">
            <div className="rounded-xl bg-slate-50 p-3 ring-1 ring-inset ring-slate-200/50">
              <p className="text-xs font-medium uppercase tracking-wider text-slate-500">Posts</p>
              <p className="mt-1 text-lg font-semibold text-slate-700">{user.totalPosts}</p>
            </div>

            <div className="rounded-xl bg-emerald-50 p-3 ring-1 ring-inset ring-emerald-600/10">
              <p className="text-xs font-medium uppercase tracking-wider text-emerald-700">Done</p>
              <p className="mt-1 text-lg font-semibold text-emerald-700">{user.completedTodos}</p>
            </div>
            ...
            <div className="rounded-xl bg-amber-50 p-3 ring-1 ring-inset ring-amber-600/10">
              ...
              <p className="mt-1 text-lg font-semibold text-amber-700">{user.pendingTodos}</p>
            </div>
          </div>
        </div>
      ))}
